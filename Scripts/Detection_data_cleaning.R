  ...
  eoe_gap_dates_20w <- missing_days(eoe_nopix_20w) # ndays is wonky but gets redone later down
  ...
  #### NEED TO FIX THE BURSTS IN HERE NOW... SOMEHOW...  ####
  #then do the last bit below
