  #'  ----------------------------------------
  #'  Latency model - competitor + prey diversity effect
  ...
  cat(file = "./Outputs/Time_btwn_Detections/tbd_competitor_preydiversity.txt", "
      model{
      ...
      for(i in 1:ntbd){
        ...
        log(tbd_mu[i]) <- alpha0 + beta.competitor[covs[i,2]] + beta.div*covs[i,10] + alpha[site[i]]
      }
