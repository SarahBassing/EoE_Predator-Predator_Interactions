#'  ----------------------------------------
#'  Latency model - competitor + prey RIA (wtd & lagomorphs) effect, no random effect
...
cat(file = "./Outputs/Time_btwn_Detections/tbd_competitor_wtd_lago_abundance_noRE.txt", "
      model{
