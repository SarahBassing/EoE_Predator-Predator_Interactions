  ...
  cat(file = "./Outputs/Time_btwn_Detections/tbd_global_sppID_X_div_elk_wtd_abundance_noRE.txt", "
      model{
      ...
      for(i in 1:ntbd){
        ...
        log(tbd_mu[i]) <- alpha0 + beta.sppID[covs[i,2]] + beta.prey[1]*covs[i,5] + beta.prey[2]*covs[i,8] + beta.div*covs[i,10] +
