  #'  ---------------------------------
  #'  Null model: interaction on detection v2
  ...
  #'  environmental/ biotic variables of interest. Allows presence of one species
  #'  to affect detection of the other.
  #'  ---------------------------------
  
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(yr)_p(.)_px(psi).txt', "
      model{
