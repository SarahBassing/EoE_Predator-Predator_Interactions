  #'  ------------------------------------
  #'  Habitat model, species interaction on detection v2
  ...
  #'  presence of one predator to affect detection of another. Code for interaction
  #'  on detection probability based on https://masonfidino.com/interpret_rota_model/
  #'  ------------------------------------
  
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(setup_habitat_yr)_p(setup_effort)_px(psi).txt', "
      model{
