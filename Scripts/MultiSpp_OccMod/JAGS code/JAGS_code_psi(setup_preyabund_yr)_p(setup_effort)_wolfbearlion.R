  #'  ------------------------------------
  #'  Prey relative abundance, no species interactions - wolf-bear, wolf-lion model
  ...
  #'  Excluding moose effects on bear/lion submodels b/c don't expect moose to 
  #'  influence their distributions.
  #'  ------------------------------------
  
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(setup_preyabund_yr)_p(setup_effort)_wolfbearlion.txt', "
      model{
