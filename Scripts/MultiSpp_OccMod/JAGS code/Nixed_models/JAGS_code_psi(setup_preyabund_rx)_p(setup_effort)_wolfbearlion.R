  ...
  #'  Excluding livestock & moose effects on bear/lion submodels b/c don't expect 
  #'  moose/cattle to influence their distributions.
  #'  ------------------------------------
  
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(setup_preyabund_rx)_p(setup_effort)_wolfbearlion.txt', "
      model{
