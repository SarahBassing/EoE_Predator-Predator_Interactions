  #'  ------------------------------------
  #'  Prey relative abundance, no species interactions - wolf-coyote model
  ...
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(setup_preyabund_yr)_p(setup_effort)_wolfcoy.txt', "
      model{
