  #'  ------------------------------------
  #'  Habitat model, species interaction on detection
  ...
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(setup_habitat_yr)_p(setup_effort)_px(.)_altGoF.txt', "
      model{
