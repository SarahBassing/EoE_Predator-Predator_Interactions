  #'  ----------------------------------------------------
  #'  Relative abundance of functional prey groups - wolf-bear (and lion-bear) model
  ...
  #'  But excluding livestock effect on bear|no wolf (or no lion) sub-model b/c do 
  #'  not expect bear distribution to be influenced by cattle in the absence of wolves
  #'  ----------------------------------------------------
  
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psix(setup_preygroup_rx)_px(setup_effort)_wolfbear.txt', "
      model{
        ...
        #'  Bear slopes (no livestock effect)
