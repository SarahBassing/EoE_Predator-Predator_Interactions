  #'  ------------------------------------
  #'  Prey diversity model - includes lagomorph effect on all psi
  ...
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psix(setup_preydiversity_rx)_px(setup_effort)_bunnySpp12.txt', "
      model{
