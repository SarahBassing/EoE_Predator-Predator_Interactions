  #'  ------------------------------------
  #'  Prey diversity model, species interaction on detection
  ...
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(setup_preydiversity_yr)_p(setup_effort)_px(.).txt', "
      model{
