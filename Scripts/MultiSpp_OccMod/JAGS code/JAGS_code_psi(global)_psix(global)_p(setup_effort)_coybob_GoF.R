  #'  ------------------------------------
  #'  Global coyote-bobcat interaction model
  ...
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psi(global)_psix(global)_p(setup_effort)_coybob_GoF.txt', "
        model{
