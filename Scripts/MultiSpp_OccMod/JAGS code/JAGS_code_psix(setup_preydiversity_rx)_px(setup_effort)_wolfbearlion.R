  #'  ------------------------------------
  #'  Prey diversity model - wolf-bear, wolf-lion model
  ...
  cat(file = './Outputs/MultiSpp_OccMod_Outputs/JAGS_output/JAGS_code_psix(setup_preydiversity_rx)_px(setup_effort)_wolfbearlion.txt', "
      model{
