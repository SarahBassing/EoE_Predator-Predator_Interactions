  ...
  format_covs <- function(cams, covs, rm_rows) {
    ...
    formatted <- transmute(cam_covs,
                           ...
                           Nmotorized = scale(human_motorizedT),
                           Nlagomorph = scale(lagomorphsT),
                           Nlivestock = scale(livestockT),
                           Nmoose = scale(mooseT),
                           Nmd = scale(muledeerT),
                           Nwtd = scale(whitetaileddeerT),
                           Nungulate = scale(ungulateT),
                           Nbig_deer = scale(big_deerT),
                           Nsmall_deer = scale(small_deerT),
