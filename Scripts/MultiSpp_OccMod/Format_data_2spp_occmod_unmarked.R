  ...
  format_covs <- function(cams, covs, rm_rows) {
    ...
    formatted <- transmute(cam_covs,
                           ...
                           Nelk = scale(elk99),
                           Nhuman = scale(human99),
                           Nhumanplus = scale(human_plus),
                           Nmotorized = scale(human_motorized),
                           Nlagomorph = scale(lagomorphs99),
                           Nlivestock = scale(livestock99),
                           Nmoose = scale(moose99),
                           Nmd = scale(muledeer99),
                           Nwtd = scale(whitetaileddeer99),
                           Nungulate = scale(ungulate99),
                           Nbig_deer = scale(big_deer99),
                           Nsmall_deer = scale(small_deer99),
