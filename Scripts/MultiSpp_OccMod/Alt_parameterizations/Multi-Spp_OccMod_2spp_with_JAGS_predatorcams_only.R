  #'  --------------------------------------------------------
  #'  Bayesian multispecies occupancy model PREDATOR CAMS ONLY 
  ...
  source("./Scripts/MultiSpp_OccMod/Format_data_2spp_occmod_for_JAGS_predatorcams_only.R")
  ...
  det_covs <- stations_eoe20s21s %>%
    mutate(CameraFacing = ifelse(CameraFacing == "trail", 0, 1),
  ...
  psi_cov[,1] <- 1
  psi_cov[,2] <- det_covs$CameraFacing            #  Note this index represents Setup in predator + ungulate JAGS setup script
  ...
  psi_inxs_cov[,1] <- 1
  psi_inxs_cov[,2] <- det_covs$CameraFacing       #  Note this index represents Setup in predator + ungulate JAGS setup script
  ...
  rho_cov[,,1] <- 1
  rho_cov[,,2] <- det_covs$Setup         # NOTE: Setup & CameraFacing indices are opposite in predator + ungulate JAGS setup script
  rho_cov[,,3] <- det_covs$CameraFacing
  ...
  rho_inxs_cov[,,1] <- 1
  rho_inxs_cov[,,2] <- det_covs$Setup     # NOTE: Setup & CameraFacing indices are opposite in predator + ungulate JAGS setup script
  rho_inxs_cov[,,3] <- det_covs$CameraFacing
  ...
  save(bundled_pred_list, file = "./Data/MultiSpp_OccMod_Outputs/bundled_predator_data_list_predatorcams_only.RData")
  ...
  save(wolf.coy.hab, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/wolfcoy_psix(setup_habitat_rx)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(wolf.coy.preygroup, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/wolfcoy_psix(setup_preygroup_rx)_px(setup_effort)_predatorcams_only.RData")
  
  #'  Prey diversity model: psi & psix = setup, elevation, forest, elk, moose, md, wtd, lagomorph; px = setup, effort
  ...
  save(wolf.coy.preydiversity, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/wolfcoy_psix(setup_preydiversity_rx)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(wolf.coy.anthro, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/wolfcoy_psix(setup_anthro_rx)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(wolf.coy.global1, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/wolfcoy_psix(global1)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(wolf.coy.global2, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/wolfcoy_psix(global2)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(coy.bob.hab, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/coybob_psix(setup_habitat_rx)_px(setup_effort)_predatorcams_only.RData") 
  ...
  save(coy.bob.preygroup, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/coybob_psix(setup_preygroup_rx)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(coy.bob.preydiversity, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/coybob_psix(setup_preydiversity_rx)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(coy.bob.anthro, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/coybob_psix(setup_anthro_rx)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(coy.bob.global1, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/coybob_psix(global1)_px(setup_effort)_predatorcams_only.RData")
  ...
  save(coy.bob.global2, file = "./Outputs/MultiSpp_OccMod_Outputs/JAGS_output/coybob_psix(global2)_px(setup_effort)_predatorcams_only.RData")
