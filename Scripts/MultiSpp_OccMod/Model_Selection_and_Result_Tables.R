  ...
  (topmod_wolflion <- dictab(cand.set = wolflion_list, modnames = wolflion_name, sort = TRUE)) # wolf.lion.null bets supported model, followed by wolf.lion.habx ... probably b/c no habitat variables matter for lions aparently 
