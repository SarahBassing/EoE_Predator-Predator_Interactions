  ...
  print(loso_tbl)
  write.csv(loso_tbl, "./Outputs/SEM/Tables_for_publication/LOSO_CV_results.csv")
  ...
  (compare_topdown <- compare_paired_mods(loso_bottomup_exploit$elpd_per_site, loso_topdown_exploit$elpd_per_site))
  (compare_topdown_inter <- compare_paired_mods(loso_bottomup_exploit$elpd_per_site, loso_topdown_inter$elpd_per_site))   # suggests a meaningful difference from bottomup_exploit
  (compare_bottomup_inter <- compare_paired_mods(loso_bottomup_exploit$elpd_per_site, loso_bottomup_inter$elpd_per_site))
  
  loso_pair <- c("Top-down, exploitative", "Top-down, interference", "Bottom-up, interference")
  loso_compare_tbl <- data.frame(Model = loso_pair, 
                                 elpd_diff = c(compare_topdown$elpd_diff, compare_topdown_inter$elpd_diff, compare_bottomup_inter$elpd_diff),
                                 se_diff = c(compare_topdown$se_diff, compare_topdown_inter$se_diff, compare_bottomup_inter$se_diff),
                                 Ratio = c(compare_topdown$ratio, compare_topdown_inter$ratio, compare_bottomup_inter$ratio)) %>%
    arrange(Ratio)
  ...
  write.csv(loso_compare_tbl, "./Outputs/SEM/Tables_for_publication/LOSO_CV_compared2BottomUp_results.csv")
