  ...
  dSep_iterations_bottomup_inter_tmin1_only <- list(
    ...
    list(spp = c("wolf"), covariate_array = data_JAGS_bundle_bottomup_inter$wolf.hat),
    # Regression #38
    ...
    list(spp = c("wolf"), covariate_array = data_JAGS_bundle_bottomup_inter$elk.hat),
    # Regression #61
    # bs_bottomup_inter[[61]] # "elk.tmin1" "wtd.tmin1"
    list(spp = c("wtd"), covariate_array = data_JAGS_bundle_bottomup_inter$elk.hat),
    # Regression #72
