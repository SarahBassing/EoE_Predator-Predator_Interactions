  ...
  dSep_iterations_bottomup_inter <- list(
    ...
    # # Regression #8
    # # bs_bottomup_inter[[8]] # "wsi.tmin1" "elk.tmin1"
    # list(dSep_test = 5, covariates = c("wsi"), spp = c(".wsi"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #9
    # bs_bottomup_inter[[9]] # "wsi.tmin1"    "bear.t"       "forest.tmin1" "bear.tmin1"   "wolf.tmin1"   "elk.tmin1"   
    list(dSep_test = 3, covariates = c("forest", "bear.latent", "wolf.latent", "elk.latent", "wsi"), spp = c(".forest", ".bear", ".wolf", ".elk", ".wsi"), indices = as.integer(c(1,1,1,1,1)), lags = c("y-1","y-1","y-1","y-1","y-1")),
    # Regression #10
    # bs_bottomup_inter[[10]] # "wsi.tmin1"   "wolf.t"      "moose.tmin1" "wolf.tmin1"  "elk.tmin1"  
    ...
    # Regression #11
    # bs_bottomup_inter[[11]] # "wsi.tmin1" "lion.t"    "wtd.tmin1" "elk.tmin1"
    ...
    # # Regression #19
    # # bs_bottomup_inter[[19]] # "coy.tmin1" "elk.tmin1"
    # list(dSep_test = 5, covariates = c("coy.latent"), spp = c(".coy"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #20
    # bs_bottomup_inter[[20]] # "coy.tmin1"    "elk.t"        "wsi.tmin1"    "forest.tmin1" "elk.tmin1"
    ...
    # Regression #21
    # bs_bottomup_inter[[21]] # "coy.tmin1"    "bear.t"       "forest.tmin1" "bear.tmin1"   "wolf.tmin1"   "elk.tmin1"   
    list(dSep_test = 3, covariates = c("forest", "bear.latent", "wolf.latent", "elk.latent", "coy.latent"), spp = c(".forest", ".bear", ".wolf", ".elk", ".coy"), indices = as.integer(c(1,1,1,1,1)), lags = c("y-1","y-1","y-1","y-1","y-1")),
    # Regression #22
    # bs_bottomup_inter[[22]] # "coy.tmin1"   "wolf.t"      "moose.tmin1" "wolf.tmin1"  "elk.tmin1" 
    ...
    # Regression #23
    # bs_bottomup_inter[[23]] # "coy.tmin1" "lion.t"    "wtd.tmin1" "elk.tmin1"
    ...
    # # Regression #26
    # # bs_bottomup_inter[[26]] # "forest.tmin1" "wolf.tmin1" 
    # list(dSep_test = 2, covariates = c("forest"), spp = c(".forest"), indices = as.integer(c(1)), lags = c("y-1")),
    # # Regression #27
    # # bs_bottomup_inter[[27]] # "forest.tmin1" "wtd.tmin1"   
    # list(dSep_test = 7, covariates = c("forest"), spp = c(".forest"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #28
    # bs_bottomup_inter[[28]] # "forest.tmin1" "coy.t"        "coy.tmin1"    "wolf.tmin1"   "wtd.tmin1"
    ...
    # # Regression #29
    # # bs_bottomup_inter[[29]] # "forest.tmin1" "elk.tmin1" 
    # list(dSep_test = 5, covariates = c("forest"), spp = c(".forest"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #30
    # bs_bottomup_inter[[30]] # "forest.tmin1" "wolf.t"       "moose.tmin1"  "wolf.tmin1"   "elk.tmin1"
    ...
    # Regression #31
    # bs_bottomup_inter[[31]] # "forest.tmin1" "lion.t"       "wtd.tmin1"    "elk.tmin1"   
    ...
    # Regression #37
    # bs_bottomup_inter[[37]] # "bear.tmin1" "coy.t"      "coy.tmin1"  "wolf.tmin1" "wtd.tmin1"
    ...
    # # Regression #38
    # # bs_bottomup_inter[[38]] # "bear.tmin1" "elk.tmin1" 
    # list(dSep_test = 5, covariates = c("bear.latent"), spp = c(".bear"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #39
    # bs_bottomup_inter[[39]] # "bear.tmin1"   "elk.t"        "wsi.tmin1"    "forest.tmin1" "elk.tmin1"
    ...
    # Regression #40
    # bs_bottomup_inter[[40]] # "bear.tmin1"  "wolf.t"      "moose.tmin1" "wolf.tmin1"  "elk.tmin1"  
    ...
    # Regression #41
    # bs_bottomup_inter[[41]] # "bear.tmin1" "lion.t"     "wtd.tmin1"  "elk.tmin1" 
    ...
    # Regression #45
    # bs_bottomup_inter[[45]] # "moose.tmin1" "coy.t"       "coy.tmin1"   "wolf.tmin1"  "wtd.tmin1"
    ...
    # # Regression #46
    # # bs_bottomup_inter[[46]] # "moose.tmin1" "elk.tmin1" 
    # list(dSep_test = 5, covariates = c("moose.latent"), spp = c(".moose"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #47
    # bs_bottomup_inter[[47]] # "moose.tmin1"  "elk.t"        "wsi.tmin1"    "forest.tmin1" "elk.tmin1"
    ...
    # Regression #48
    # bs_bottomup_inter[[48]] # "moose.tmin1"  "bear.t"       "forest.tmin1" "bear.tmin1"   "wolf.tmin1"   "elk.tmin1"   
    list(dSep_test = 3, covariates = c("forest", "bear.latent", "wolf.latent", "elk.latent", "moose.latent"), spp = c(".forest", ".bear", ".wolf", ".elk", ".moose"), indices = as.integer(c(1,1,1,1,1)), lags = c("y-1","y-1","y-1","y-1","y-1")),
    # Regression #49
    # bs_bottomup_inter[[49]] # "moose.tmin1" "lion.t"      "wtd.tmin1"   "elk.tmin1" 
    ...
    # bs_bottomup_inter[[50]] # "moose.t"      "wolf.tmin1"   "wsi.tmin1"    "forest.tmin1" "moose.tmin1"
    ...
    # bs_bottomup_inter[[51]] # "moose.t"      "wtd.tmin1"    "wsi.tmin1"    "forest.tmin1" "moose.tmin1"
    ...
    # Regression #52
    # bs_bottomup_inter[[52]] # "moose.t"      "wtd.t"        "wsi.tmin1"    "forest.tmin1" "moose.tmin1"  "wtd.tmin1"
    ...
    # Regression #53
    # bs_bottomup_inter[[53]] # "moose.t"      "coy.t"        "wsi.tmin1"    "forest.tmin1" "moose.tmin1"  "coy.tmin1"    "wolf.tmin1"   "wtd.tmin1"
    ...
    # bs_bottomup_inter[[54]] # "moose.t"      "elk.tmin1"    "wsi.tmin1"    "forest.tmin1" "moose.tmin1"
    ...
    # Regression #55
    # bs_bottomup_inter[[55]] # "moose.t"      "elk.t"        "wsi.tmin1"    "forest.tmin1" "moose.tmin1"  "elk.tmin1"
    ...
    # Regression #56
    # bs_bottomup_inter[[56]] # "moose.t"      "bear.t"       "wsi.tmin1"    "forest.tmin1" "moose.tmin1"  "bear.tmin1"   "wolf.tmin1"   "elk.tmin1"   
    list(dSep_test = 3, covariates = c("wsi", "forest", "moose.latent", "bear.latent", "wolf.latent", "elk.latent", "moose.latent"), spp = c(".wsi", ".forest", ".moose", ".bear", ".wolf", ".elk", ".moose"), indices = as.integer(c(1,1,1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1","y-1","y")),
    # Regression #57
    # bs_bottomup_inter[[57]] # "moose.t"      "wolf.t"       "wsi.tmin1"    "forest.tmin1" "moose.tmin1"  "wolf.tmin1"   "elk.tmin1"   
    ...
    # Regression #58
    # bs_bottomup_inter[[58]] # "moose.t"      "lion.t"       "wsi.tmin1"    "forest.tmin1" "moose.tmin1"  "wtd.tmin1"    "elk.tmin1"   
    ...
    # # Regression #59
    # # bs_bottomup_inter[[59]] # "wolf.tmin1" "wtd.tmin1" 
    # list(dSep_test = 7, covariates = c("wolf.latent"), spp = c(".wolf"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #60
    # bs_bottomup_inter[[60]] # "wolf.tmin1"   "wtd.t"        "wsi.tmin1"    "forest.tmin1" "wtd.tmin1"  
    ...
    # # Regression #61
    # # bs_bottomup_inter[[61]] # "wolf.tmin1" "elk.tmin1" 
    # list(dSep_test = 5, covariates = c("wolf.latent"), spp = c(".wolf"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #62
    # bs_bottomup_inter[[62]] # "wolf.tmin1"   "elk.t"        "wsi.tmin1"    "forest.tmin1" "elk.tmin1"   
    ...
    # Regression #63
    # bs_bottomup_inter[[63]] # "wolf.tmin1" "lion.t"     "wtd.tmin1"  "elk.tmin1" 
    ...
    # # Regression #64
    # # bs_bottomup_inter[[64]] # "wtd.tmin1" "elk.tmin1" 
    # list(dSep_test = 5, covariates = c("wtd.latent"), spp = c(".wtd"), indices = as.integer(c(1)), lags = c("y-1")),
    # Regression #65
    # bs_bottomup_inter[[65]] # "wtd.tmin1"    "elk.t"        "wsi.tmin1"    "forest.tmin1" "elk.tmin1" 
    ...
    # Regression #66
    # bs_bottomup_inter[[65]] # "wtd.tmin1"    "bear.t"       "forest.tmin1" "bear.tmin1"   "wolf.tmin1"   "elk.tmin1" 
    list(dSep_test = 3, covariates = c("forest", "bear.latent", "wolf.latent", "elk.latent", "wtd.latent"), spp = c(".forest", ".bear", ".wolf", ".elk", ".wtd"), indices = as.integer(c(1,1,1,1,1)), lags = c("y-1","y-1","y-1","y-1","y-1")),
    # Regression #67
    # bs_bottomup_inter[[67]] # "wtd.tmin1"   "wolf.t"      "moose.tmin1" "wolf.tmin1"  "elk.tmin1"  
    ...
    # Regression #68
    # bs_bottomup_inter[[68]] # "wtd.t"        "coy.t"        "wsi.tmin1"    "forest.tmin1" "wtd.tmin1"    "coy.tmin1"    "wolf.tmin1"
    ...
    # ########
    # Regression #69          # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # bs_bottomup_inter[[69]] # "wtd.t"        "elk.tmin1"    "wsi.tmin1"    "forest.tmin1" "wtd.tmin1" 
    ...
    # Regression #70
    # bs_bottomup_inter[[70]] # "wtd.t"        "elk.t"        "wsi.tmin1"    "forest.tmin1" "wtd.tmin1"    "elk.tmin1"   
    ...
    # Regression #71
    # bs_bottomup_inter[[71]] # "wtd.t"        "bear.t"       "wsi.tmin1"    "forest.tmin1" "wtd.tmin1"    "bear.tmin1"   "wolf.tmin1"   "elk.tmin1"   
    list(dSep_test = 4, covariates = c("wsi", "forest", "wtd.latent", "bear.latent", "wolf.latent", "elk.latent", "wtd.latent"), spp = c(".wsi", ".forest", ".wtd", ".bear", ".wolf", ".elk", ".wtd"), indices = as.integer(c(1,1,1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1","y-1","y")),
    # Regression #72
    # bs_bottomup_inter[[72]] # "wtd.t"        "wolf.t"       "wsi.tmin1"    "forest.tmin1" "wtd.tmin1"    "moose.tmin1"  "wolf.tmin1"   "elk.tmin1"     
    ...
    # Regression #73
    # bs_bottomup_inter[[73]] # "wtd.t"        "lion.t"       "wsi.tmin1"    "forest.tmin1" "wtd.tmin1"    "elk.tmin1"   
    ...
    # Regression #74
    # bs_bottomup_inter[[74]] # "coy.t"      "elk.tmin1"  "coy.tmin1"  "wolf.tmin1" "wtd.tmin1" 
    list(dSep_test = 5, covariates = c("coy.latent", "wolf.latent", "wtd.latent", "coy.latent"), spp = c(".coy", ".wolf", ".wtd", ".coy"), indices = as.integer(c(1,1,1,2)), lags = c("y-1","y-1","y-1","y")),
    # Regression #75
    # bs_bottomup_inter[[75]] # "coy.t"        "elk.t"        "coy.tmin1"    "wolf.tmin1"   "wtd.tmin1"    "wsi.tmin1"    "forest.tmin1" "elk.tmin1" 
    list(dSep_test = 5, covariates = c("coy.latent", "wolf.latent", "wtd.latent", "wsi", "forest", "elk.latent", "coy.latent"), spp = c(".coy", ".wolf", ".wtd", ".wsi", ".forest", ".elk", ".coy"), indices = as.integer(c(1,1,1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1","y-1","y")),
    # Regression #76
    # bs_bottomup_inter[[76]] # "coy.t"        "bear.t"       "coy.tmin1"    "wolf.tmin1"   "wtd.tmin1"    "forest.tmin1" "bear.tmin1"   "elk.tmin1" 
    list(dSep_test = 3, covariates = c("coy.latent", "wolf.latent", "wtd.latent", "forest", "bear.latent", "elk.latent", "coy.latent"), spp = c(".coy", ".wolf", ".wtd", ".forest", ".bear", ".elk", ".coy"), indices = as.integer(c(1,1,1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1","y-1","y")),
    # Regression #77
    # bs_bottomup_inter[[77]] # "coy.t"       "wolf.t"      "coy.tmin1"   "wolf.tmin1"  "wtd.tmin1"   "moose.tmin1" "elk.tmin1" 
    list(dSep_test = 2, covariates = c("coy.latent", "wolf.latent", "wtd.latent", "moose.latent", "elk.latent", "coy.latent"), spp = c(".coy", ".wolf", ".wtd", ".moose", ".elk", ".coy"), indices = as.integer(c(1,1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1","y")),
    # Regression #78
    # bs_bottomup_inter[[78]] # "coy.t"      "lion.t"     "coy.tmin1"  "wolf.tmin1" "wtd.tmin1"  "elk.tmin1" 
    list(dSep_test = 1, covariates = c("coy.latent", "wolf.latent", "wtd.latent", "elk.latent", "coy.latent"), spp = c(".coy", ".wolf", ".wtd", ".elk", ".coy"), indices = as.integer(c(1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y")),
    # Regression #79
    # bs_bottomup_inter[[79]] # "elk.t"        "bear.t"       "wsi.tmin1"    "forest.tmin1" "elk.tmin1"    "bear.tmin1"   "wolf.tmin1"
    ...
    # Regression #80
    # bs_bottomup_inter[[80]] # "elk.t"        "wolf.t"       "wsi.tmin1"    "forest.tmin1" "elk.tmin1"    "moose.tmin1"  "wolf.tmin1"
    ...
    # Regression #81
    # bs_bottomup_inter[[84]] # "elk.t"        "lion.t"       "wsi.tmin1"    "forest.tmin1" "elk.tmin1"    "wtd.tmin1"   
    ...
    # Regression #82
    # bs_bottomup_inter[[82]] # "bear.t"       "wolf.t"       "forest.tmin1" "bear.tmin1"   "wolf.tmin1"   "elk.tmin1"    "moose.tmin1" 
    list(dSep_test = 2, covariates = c("forest", "bear.latent", "wolf.latent", "elk.latent", "moose.latent", "bear.latent"), spp = c(".forest", ".bear", ".wolf", ".elk", ".moose", ".bear"), indices = as.integer(c(1,1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1","y")),
    # Regression #83
    # bs_bottomup_inter[[83]] # "bear.t"       "lion.t"       "forest.tmin1" "bear.tmin1"   "wolf.tmin1"   "elk.tmin1"    "wtd.tmin1"
    list(dSep_test = 1, covariates = c("forest", "bear.latent", "wolf.latent", "elk.latent", "wtd.latent", "bear.latent"), spp = c(".forest", ".bear", ".wolf", ".elk", ".wtd", ".bear"), indices = as.integer(c(1,1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1","y")),
    # Regression #84
    # bs_bottomup_inter[[84]] # "wolf.t"      "lion.t"      "moose.tmin1" "wolf.tmin1"  "elk.tmin1"   "wtd.tmin1"
