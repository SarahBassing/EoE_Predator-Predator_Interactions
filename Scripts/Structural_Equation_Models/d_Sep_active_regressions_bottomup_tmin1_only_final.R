  #'  ----------------------------------------------------------------
  #'  Inputs for for d-Sep iterations when t-1 --> t-1: bottom-up FINAL
  #'  Aug 2026
  #'  ----------------------------------------------------------------
  ...
  #'  
  #'  This list of inputs differs from the input structure in d_Sep_active_regressions_bottomup_final.R
  ...
  dSep_iterations_bottomup_tmin1_only_final <- list(
    # Regression #1
    # bs_bottomup_final[[1]] # "wsi.tmin1" "coy.tmin1"
    list(spp = c("coy"), covariate_array = data_JAGS_bundle_bottomup_final$wsi),
    # Regression #3
    # bs_bottomup_final[[3]] # "wsi.tmin1"  "bear.tmin1"
    list(spp = c("bear"), covariate_array = data_JAGS_bundle_bottomup_final$wsi),
    # Regression #4
    # bs_bottomup_final[[4]] # "wsi.tmin1"   "moose.tmin1"
    list(spp = c("moose"), covariate_array = data_JAGS_bundle_bottomup_final$wsi),
    # Regression #5
    # bs_bottomup_final[[5]] # "wsi.tmin1"  "wolf.tmin1"
    list(spp = c("wolf"), covariate_array = data_JAGS_bundle_bottomup_final$wsi),
    # Regression #6
    # bs_bottomup_final[[6]] # "wsi.tmin1" "wtd.tmin1"
    list(spp = c("wtd"), covariate_array = data_JAGS_bundle_bottomup_final$wsi),
    # Regression #8
    # bs_bottomup_final[[8]] # "wsi.tmin1" "elk.tmin1"
    list(spp = c("elk"), covariate_array = data_JAGS_bundle_bottomup_final$wsi),
    ...
    list(spp = c("coy"), covariate_array = data_JAGS_bundle_bottomup_final$forest),
    # Regression #13
    # bs_bottomup_final[[13]] # "coy.tmin1"  "bear.tmin1"
    list(spp = c("bear"), covariate_array = data_JAGS_bundle_bottomup_final$coy.hat),
    # Regression #14
    # bs_bottomup_final[[14]] # "coy.tmin1"   "moose.tmin1"
    list(spp = c("moose"), covariate_array = data_JAGS_bundle_bottomup_final$coy.hat),
    # Regression #16
    # bs_bottomup_final[[16]] # "coy.tmin1"  "wolf.tmin1"
    list(spp = c("wolf"), covariate_array = data_JAGS_bundle_bottomup_final$coy.hat),
    # Regression #17
    # bs_bottomup_final[[17]] # "coy.tmin1" "wtd.tmin1"
    list(spp = c("wtd"), covariate_array = data_JAGS_bundle_bottomup_final$coy.hat),
    # Regression #18
    # bs_bottomup_final[[18]] # "coy.tmin1" "elk.tmin1"
    list(spp = c("elk"), covariate_array = data_JAGS_bundle_bottomup_final$coy.hat),
    # Regression #23
    # bs_bottomup_final[[23]] # "forest.tmin1" "bear.tmin1"
    list(spp = c("bear"), covariate_array = data_JAGS_bundle_bottomup_final$forest),
    # Regression #24
    # bs_bottomup_final[[34]] # "forest.tmin1" "moose.tmin1"
    list(spp = c("moose"), covariate_array = data_JAGS_bundle_bottomup_final$forest),
    # Regression #25
    # bs_bottomup_final[[25]] # "forest.tmin1" "wolf.tmin1"
    list(spp = c("wolf"), covariate_array = data_JAGS_bundle_bottomup_final$forest),
    # Regression #26
    # bs_bottomup_final[[26]] # "forest.tmin1" "wtd.tmin1"
    list(spp = c("wtd"), covariate_array = data_JAGS_bundle_bottomup_final$forest),
    # Regression #28
    # bs_bottomup_final[[28]] # "forest.tmin1" "elk.tmin1"
    list(spp = c("elk"), covariate_array = data_JAGS_bundle_bottomup_final$forest),
    # Regression #31
    # bs_bottomup_final[[31]] # "bear.tmin1"  "moose.tmin1"
    list(spp = c("moose"), covariate_array = data_JAGS_bundle_bottomup_final$bear.hat),
    # Regression #33
    # bs_bottomup_final[[33]] # "bear.tmin1" "wolf.tmin1"
    list(spp = c("wolf"), covariate_array = data_JAGS_bundle_bottomup_final$bear.hat),
    # Regression #34
    # bs_bottomup_final[[34]] # "bear.tmin1" "wtd.tmin1"
    list(spp = c("wtd"), covariate_array = data_JAGS_bundle_bottomup_final$bear.hat),
    # Regression #36
    # bs_bottomup_final[[36]] # "bear.tmin1" "elk.tmin1"
    list(spp = c("elk"), covariate_array = data_JAGS_bundle_bottomup_final$bear.hat),
    # Regression #39
    # bs_bottomup_final[[39]] # "moose.tmin1" "wolf.tmin1"
    list(spp = c("wolf"), covariate_array = data_JAGS_bundle_bottomup_final$moose.hat),
    # Regression #40
    # bs_bottomup_final[[40]] # "moose.tmin1" "wtd.tmin1"
    list(spp = c("wtd"), covariate_array = data_JAGS_bundle_bottomup_final$moose.hat),
    # Regression #43
    # bs_bottomup_final[[43]] # "moose.tmin1" "elk.tmin1"
    list(spp = c("elk"), covariate_array = data_JAGS_bundle_bottomup_final$moose.hat),
    # Regression #55
    # bs_bottomup_final[[55]] # "wolf.tmin1" "wtd.tmin1"
    list(spp = c("wtd"), covariate_array = data_JAGS_bundle_bottomup_final$wolf.hat),
    # Regression #58
    # bs_bottomup_final[[58]] # "wolf.tmin1" "elk.tmin1"
    list(spp = c("elk"), covariate_array = data_JAGS_bundle_bottomup_final$wolf.hat),
    # Regression #62
    # bs_bottomup_final[[62]] # "wtd.tmin1" "elk.tmin1"
    list(spp = c("elk"), covariate_array = data_JAGS_bundle_bottomup_final$wtd.hat)
  )
