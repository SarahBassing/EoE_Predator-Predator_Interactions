  #'  ----------------------------------------------------------------
  #'  Inputs for for d-Sep iterations for cor(exog, exog): bottom-up interference FINAL
  #'  Sept 2026
  #'  ----------------------------------------------------------------
  ...
  dSep_iterations_bottomup_inter_exog_only_final <- list(
    # Regression #2
    # bs_bottomup_inter_final[[2]] # "wsi.tmin1"    "forest.tmin1"
    list(y_array = data_JAGS_bundle_bottomup_inter_final$forest, x_array = data_JAGS_bundle_bottomup_inter_final$wsi)
  )
