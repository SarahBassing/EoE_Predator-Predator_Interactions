  ...
  dSep_iterations_topdown <- list(
    ...
    list(mode = "aux", outcome_spp_name = "wtd", covariates = c("deerHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y"))#,
    # # Regression #2
    # # bs_topdown[[2]] # "deerHarv.tmin1" "moose.tmin1"
    # # list(dSep_test = 6, covariates = c("deerHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1"))#,
    # list(mode = "aux", outcome_spp_name = "moose", covariates = c("deerHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y")),
    # 
    # # # Regression #3
    ...
    # list(dSep_test = ????, covariates = c("deerHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # # Regression #5
    ...
    # ##### tmin1 - tmin1  ########
    # #########
    # # Regression #19   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[19]] # "wtd.tmin1"     "elkHarv.tmin1"
    # list(dSep_test = 7, covariates = c("elkHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # #########
    # 
    # ##### tmin1 - tmin1  ########
    # # Regression #20
    ...
    # ##### tmin1 - tmin1  ########
    # ##########
    # # Regression #24   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    ...
    # ##### tmin1 - tmin1  ########
    # ##########
    # # Regression #27   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    ...
    # ##### tmin1 - tmin1  ########
    # ##########
    # # Regression #32   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    ...
    # ##### tmin1 - tmin1  ########
    # ##########
    # # Regression #34   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[34]] # "moose.tmin1"   "elkHarv.tmin1"
    # list(dSep_test = 6, covariates = c("elkHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # ##########
    # 
    # ##### tmin1 - tmin1  ########
    # # Regression #35
    ...
    # list(dSep_test = 4, covariates = c("moose.latent"), spp = c(".moose"), indices = c(1), lags = c("y-1")), 
    # # Regression #39
    ...
    # ##### tmin1 - tmin1  ########
    # ##########
    # # Regression #40   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[40]] # "moose.tmin1"    "bearHarv.tmin1"
    # list(dSep_test = 6, covariates = c("bearHarv"), spp = c(".moose"), indices = c(1), lags = c("y-1")),
    # ##########
    # 
    # ##### tmin1 - tmin1  ########
    # # Regression #41
    ...
    # list(dSep_test = 2, covariates = c("moose.latent"), spp = c(".moose"), indices = c(1), lags = c("y-1")),
    # # Regression #45
    ...
    # list(dSep_test = 2, covariates = c("elkHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # # Regression #50
    ...
    # list(dSep_test = 5, covariates = c("elkHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # # Regression #52
    # # bs_topdown[[52]] # "elkHarv.tmin1" "coy.tmin1" 
    # list(dSep_test = 4, covariates = c("elkHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # # Regression #53
    ...
    # list(dSep_test = 3, covariates = c("elkHarv"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # # Regression #56 
    ...
    # list(dSep_test = 3, covariates = c("lion.latent"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # # Regression #68
    ...
    # list(dSep_test = 2, covariates = c("lion.latent"), spp = c(".harvest"), indices = c(1), lags = c("y-1")),
    # # Regression #71
    ...
    # 
    # ##########    
    # # Regression #73    # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    ...
    # list(dSep_test = 4, covariates = c("elk.latent"), spp = c(".elk"), indices = as.integer(c(1)), lags = c("y-1")),
    # # Regression #89
    ...
    # 
    # ##########
    # # Regression #90   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[90]] # "elk.tmin1"      "bearHarv.tmin1"
    # list(dSep_test = 5, covariates = c("bearHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # ##########
    # 
    # # Regression #91
    # # bs_topdown[[91]] # "elk.tmin1"  "bear.tmin1"
    # list(dSep_test = 3, covariates = c("elk.latent"), spp = c(".elk"), indices = as.integer(c(1)), lags = c("y-1")),
    # # Regression #92
    ...
    # 
    # ##########
    # # Regression #93   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[93]] # "elk.tmin1"  "wolfHarv.tmin1"
    # list(dSep_test = 5, covariates = c("wolfHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # ##########
    # 
    # # Regression #94
    ...
    # 
    # ##########
    # # Regression #97   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    ...
    # 
    # ##########
    # # Regression #102   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[102]] # "coy.tmin1"      "wolfHarv.tmin1"
    # list(dSep_test = 4, covariates = c("wolfHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # ##########
    # 
    # # Regression #103
    ...
    # 
    # ##########
    # # Regression #107   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[107]] # "coy.tmin1"      "lionHarv.tmin1"
    # list(dSep_test = 4, covariates = c("lionHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # ##########
    # 
    # # Regression #108
    ...
    # list(dSep_test = 3, covariates = c("bearHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # 
    # # # Regression #120
    ...
    # list(dSep_test = 2, covariates = c("bearHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # # Regression #122
    ...
    # 
    # ############
    # # Regression #127   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    ...
    # list(dSep_test = 2, covariates = c("bear.latent"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # # Regression #129
    ...
    # 
    # ############
    # # Regression #132   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[132]] # "bear.tmin1" "lionHarv.tmin1"
    # list(dSep_test = 3, covariates = c("lionHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # ############
    # 
    # # Regression #133
    ...
    # list(dSep_test = NA, covariates = c("bearHarv", "bear.latent", "lionHarv"), spp = c(".harvest", ".bear", ".harvest"), indices = as.integer(c(1,1,2)), lags = c("y-1","y-1","y-1")),
    # ##########
    # 
    # # Regression #140
    ...
    # list(dSep_test = 2, covariates = c("wolfHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # # Regression #142
    ...
    # 
    # #########
    # # Regression #146   # NOTE: I'VE FLIPPED THE RESPONSE & EXPLANATORY VARIABLES HERE SO THE INDEP. CLAIM IS TEMPORALLY VALID
    # # bs_topdown[[146]] # "wolf.tmin1"     "lionHarv.tmin1"
    # list(dSep_test = 2, covariates = c("lionHarv"), spp = c(".harvest"), indices = as.integer(c(1)), lags = c("y-1")),
    # #########
    # 
    # # Regression #147
    ...
    # list(dSep_test = 5, covariates = c("elkHarv.tmin1", "lion.tmin1", "elk.tmin1", "wolf.tmin1", "lionHarv.tmin1"), spp = c(".harvest", ".lion", ".elk", ".wolf", ".harvest"), indices = as.integer(c(1,1,1,1,2)), lags = c("y-1","y-1","y-1","y-1","y-1")),
    # ##########
    # 
    # # Regression #154
    ...
    # list(dSep_test = 2, covariates = c("wolfHarv.latent", "wolf.latent", "lionHarv"), spp = c(".harvest", ".wolf", ".harvest"), indices = as.integer(c(1,1,2)), lags = c("y-1","y-1","y-1")),
    # ##########
    # 
    # # Regression #156
