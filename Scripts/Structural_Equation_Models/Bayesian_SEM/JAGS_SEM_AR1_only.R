#'  --------------------------------------------------------
#'  JAGS model: Auto-reggression only SEM
#'  
#'  Model description: 
...
#'    h: number of betas for 1-yr lag harvest effect (nharvest, 0, one per species except coy)
...
#'  --------------------------------------------------------
cat(file = './Outputs/SEM/JAGS_out/JAGS_SEM_AR1_only.txt', "
      model{
