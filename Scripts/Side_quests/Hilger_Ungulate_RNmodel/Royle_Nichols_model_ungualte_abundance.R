  ...
  ######  Community Composition  ######
  #'  Selected & Proportion Selected  (DIC = 39927.54)
  start.time = Sys.time()
  inits_wtd_Aug <- function(){list(N = ninit_wtd[[2]])}
  ...
  #'  Predicted & Proportion Selected  (DIC = 39928.4)
  start.time = Sys.time()
  inits_wtd_Aug <- function(){list(N = ninit_wtd[[2]])}
