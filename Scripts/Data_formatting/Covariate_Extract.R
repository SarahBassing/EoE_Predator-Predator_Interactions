  ...
  spread_of_covariate_data <- function(covs, season) {
    ...
    hist(covs$elk_perday, breaks =  20, main = paste("Frequency of elk detection rate at cameras\n", season))
    ...
    hist(covs$lagomorphs_perday, breaks =  20, main = paste("Frequency of lagomorph detection rate at cameras\n", season))
    ...
    hist(covs$moose_perday, breaks =  20, main = paste("Frequency of moose detection rate at cameras\n", season))
    ...
    hist(covs$whitetaileddeer_perday, breaks =  30, main = paste("Frequency of white-tailed deer detection rate at cameras\n", season))
